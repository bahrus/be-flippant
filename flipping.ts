/**
 * Code lifted (with minor, but breaking changes) from: https://github.com/davidkpiano/flipping
 * 
 */
import {StyleMap, Rect, Delta, FlipData, FlipElementMap, FlipListener, FlippingConfig} from './types';
...
export class Flipping {
    ...
    #findAncestor(element: HTMLElement): HTMLElement | undefined {
